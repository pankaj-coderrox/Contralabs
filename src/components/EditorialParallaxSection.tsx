  ...
  useGSAP(
    () => {
      ...
      timeline
        ...
        .addLabel("text-2", 1.9)
        .set(textThree, hiddenTextState, 1.9)
        .fromTo(
          textTwo,
          hiddenTextState,
          {
        ...
        .to(textTwo, { ...visibleTextState, duration: 0.75, ease: "none" }, 2.2)
        .to(
          textTwo,
          {
            ...hiddenTextState,
        ...
        .addLabel("text-3", 3.3)
        .set(textOne, hiddenTextState, 3.3)
        .fromTo(
          textThree,
          hiddenTextState,
          {
        ...
        .to(textThree, { ...visibleTextState, duration: 1.1, ease: "none" }, 3.6);
